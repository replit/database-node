...
  public get(key: keyof T, options: { raw: true }): Promise<string>; 
 ...
   public get<K extends keyof T>(key: K, options?: { raw?: boolean }): Promise<T[K] | string>; 
  /**
    ...
    */
  public fetch(key: keyof T, options: { raw: true }): Promise<string>; 
  public fetch<K extends keyof T>(key: K, options?: { raw?: false }): Promise<T[K]>; 
  public fetch<K extends keyof T>(key: K, options?: { raw?: boolean }): Promise<T[K] | string>; 
  /** 
    * Sets a key 
    * @param key Key 
    * @param value Value 
